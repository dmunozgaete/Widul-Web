...
}),angular.module("config",[]).constant("GLOBAL_CONFIGURATION",{application:{version:"1.0.0-rc.1",environment:"dev",language:"es",name:"Widul",home:"public/home"},on_build_new_version:function(){localStorage.setItem("$_new_version",1)},localstorageStamps:{personal_data:"$_personal_data",new_version:"$_new_version"}});
